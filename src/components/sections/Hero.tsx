        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Luxury 2-bedroom apartment in the heart of downtown. Walking distance to restaurants,
              shopping, and major attractions. Perfect for business travelers and weekend getaways.
            </p>
            ...
            <div className="mt-6 flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>Downtown Financial District • 4.9★ (127 reviews)</span>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Downtown loft with city skyline views"
                  fill
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">Under 1hr</span>
              </p>
            </div>
          </div>
        </div>
