...
export default function ProductGrid() {
  const properties = [
    ...
    {
      id: 5,
      name: 'Modern One-Bedroom Central',
      pricePerNight: 135,
    ...
    },
    {
      ...
      location: 'Residential Park Area',
      guests: 6,
      bedrooms: '2 Bedrooms',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Choose from our collection of 6 professionally managed vacation rentals
          </p>
        </div>
          ...
          {properties.map(property => (
            ...
            >
              ...
              <CardFooter className="p-4 pt-0">
                ...
                >
                  {property.availability === 'Available' ? 'Check Availability' : 'View Details'}
                </Button>
              </CardFooter>
            </Card>
          ))}
        ...
        <div className="mt-12 text-center">
          <div className="bg-card p-6 rounded-lg border">
            <h3 className="text-lg font-semibold text-foreground mb-2">Direct Booking Benefits</h3>
            <p className="text-muted-foreground mb-4">
              Book directly with Local Stays and enjoy better rates, flexible cancellation, and
              personalized service
            </p>
            <Button variant="outline">View All Amenities & Policies</Button>
          </div>
        </div>
      </div>
    </section>
