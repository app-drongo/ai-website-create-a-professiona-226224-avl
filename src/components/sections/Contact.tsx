...
export default function Contact() {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      contact: 'bookings@localstays.com',
      action: 'Send Email',
    },
    {
      icon: Phone,
  ...
  const supportTopics = [
    {
      ...
      description: 'Help with reservations, availability, and modifications',
    },
    {
      icon: Home,
    ...
    },
    {
      icon: Shield,
      title: 'Guest Support',
      description: 'Check-in help, maintenance requests, and emergency contact',
    },
  ];
  ...
  const properties = [
    ...
    'Riverside 1-Bedroom',
    'Historic District 2-Bedroom',
    'Garden View 1-Bedroom',
    'City Center Studio',
    'Parkside 2-Bedroom',
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Questions about our apartments? Need booking assistance? Our local team is ready to help
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          ...
          <Card className="border-border/50">
            <CardHeader>
              ...
              <CardDescription>
                Get personalized assistance for your booking or stay inquiry.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your travel dates, group size, or any specific questions about our apartments..."
                  />
                </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="secondary">9 AM - 9 PM</Badge>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-primary/10 rounded-lg">
                  <p className="text-sm text-primary font-medium flex items-center gap-2">
                    <MapPin className="size-4" />
                    Local property manager available 24/7 for guest emergencies
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/50">
              <CardContent className="p-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p className="text-muted-foreground">Walking distance to all our apartments</p>
                </div>
                <div className="mt-4 pt-4 border-t border-border/50">
                  <p className="text-sm text-muted-foreground">
                    <strong>Check-in Support:</strong> Meet our team member at your apartment for
