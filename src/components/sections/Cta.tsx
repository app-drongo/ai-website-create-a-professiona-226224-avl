...
export default function CTA() {
  const stats = [
    ...
    { value: '24/7', label: 'Guest Support', icon: Shield },
    { value: '6', label: 'Premium Properties', icon: Zap },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Book directly with Local Stays and save on platform fees while enjoying personalized
                service and premium accommodations in the heart of the city.
              </p>
              ...
              <div className="text-center mb-12">
                ...
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* Review platform logos placeholders */}
                  {[...Array(5)].map((_, i) => (
                    <div
                      key={i}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Immediate booking confirmation and check-in details
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Personal recommendations and local insider tips included
              </p>
            </div>
          </div>
        </div>
